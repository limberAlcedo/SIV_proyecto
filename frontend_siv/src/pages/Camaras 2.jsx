      ...
      {focusedCam && (
        <motion.div className="fullscreen-wrapper d-flex justify-content-center align-items-center">
          ...
          >
            ...
            <div className="action-buttons position-absolute d-flex gap-2 flex-wrap">
              {/* Captura */}
              <Button
                variant="success"
                onClick={() => {
                  ...
                  link.href = imageData;
                  link.download = `${focusedCam.title.replace(/\s+/g, "_")}_captura.jpg`;
                  link.click();
                }}
              >
                📸 Capturar
              ...
              {/* Grabación */}
              <Button
                variant={isRecording ? "danger" : "warning"}
                onClick={() => {
                  if (isRecording) {
                    ...
                    mediaRecorder.onstop = () => {
                      ...
                      const link = document.createElement("a");
                      link.href = url;
                      link.download = `${focusedCam.title.replace(/\s+/g, "_")}_video.webm`;
                      link.click();
                    };
